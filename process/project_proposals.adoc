...
. *Due Diligence review* _2-6 weeks_
   ...
   * TOC Incubation sponsor decides when to call TOC vote, allowing at least one week for public comment before calling vote
...
. *TOC member kicks off one week period of time for pulic comment on the TOC mailing list*
