...
about: This template provides the project with a framework to archive a project.
...
This template outlines the steps to be completed when a project is officially archived.
...
- [ ] Move project to archived on the [landscape](https://github.com/cncf/landscape).
...
- [ ] Remove mailing list from maintainers@ mailing group (google groups).
...
- [ ] Request level change on [PCC](https://jira.linuxfoundation.org/plugins/servlet/desk/portal/4/create/358)
