...
توسعه و پیاده‌سازی برنامه‌ها به شیوه‌ی کلاد نیتیو به سازمان‌ها این امکان را می‌دهد که در محیط‌های رایانش ابری (ابر عمومی، خصوصی، ترکیبی) نیازهای خود را در مقیاس وسیع، به‌صورت برنامه‌پذیر و تکرارپذیر برآورده کنند. این روش بر سیستم‌های کم‌اتصال تمرکز دارد که به‌صورت امن، مقاوم، قابل مدیریت، پایدار و قابل مشاهده با یکدیگر تعامل دارند.

با ترکیب خودکارسازی قدرتمند، رویکردهای کلاد نیتیو به سازمان‌ها اجازه می‌دهند که تغییرات مهم را با حداقل تلاش، به‌صورت مکرر، پیش‌بینی‌پذیر و با جداسازی شفاف وظایف انجام دهند.

بنیاد محاسبات کلاد نیتیو (Cloud Native Computing Foundation) پذیرش این پارادایم را از طریق پرورش و نگهداری یک اکوسیستم متن‌باز و بی‌طرف نسبت به فروشندگان ترویج می‌دهد. ما با دموکراتیک‌سازی الگوهای پیشرفته، این نوآوری‌ها را برای همه در دسترس قرار می‌دهیم.
