...
> **TOC Reviewer Note:** Control-plane cert rotation is manual (365-day default); Expired certs crash control-plane components with no documented recovery path. Acknowledged gap in [community#69](https://github.com/karmada-io/community/issues/69), unresolved as of v1.14. Project should document a rotation runbook and roadmap automation.
