...
- Some additional investments would be: finding ways and means to grow beyond the .NET ecosystem, better upgrades, and simplified certificate rotation especially when users have lots of clusters to deal with (without needing an additional product/service)
