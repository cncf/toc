...
TOC Members, Karena Angell and Dims, conducted the due diligence of Crossplane who applied for CNCF Graduation. The project has completed the criteria that show its maturity at the level of Graduation. The following criteria implementations are noteworthy to call out:
...
The adopter interviews reflect a project in use for the level which the project applied. They show ... $INTERVIEWSUMMARY._
