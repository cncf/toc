...
- According to devstats, Kube-OVN currently has [110](https://kubeovn.devstats.cncf.io/d/22/prs-authors-table?orgId=1) PRs authors from [39](https://kubeovn.devstats.cncf.io/d/5/companies-table?orgId=1)
...
- The community has grown significantly since the project entered the CNCF sandbox.
    ...
    - Number of PRs authors: 31 -> **110+**
    - Number of PRs authors organizations: 13 -> **39**
    - Number of Contributors: 62 -> **308**
    - Last Release: **v1.12.4**
    - Member of WeChat Group: **1500+**
...
There are [110](https://kubeovn.devstats.cncf.io/d/22/prs-authors-table?orgId=1) PR authors in Kube-OVN, out of which there are 6 maintainers from 4 different organizations.
