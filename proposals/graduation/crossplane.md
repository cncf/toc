...
as a strong base of contributors to the project.  We are currently in the top
10% of all CNCF projects for contributor authors, at position [18 out of
173](https://docs.google.com/spreadsheets/d/1uDIQywu3itQEkxN3rEzvJgydl1Q5gTw5YFOdSMWSc30/edit#gid=0).
This number of PR authors has tripled from 184 at the time of Incubation to over
[660](https://crossplane.devstats.cncf.io/d/22/prs-authors-table?orgId=1)
currently and the diversity of companies contributing also tripled from 105 to
[338](https://crossplane.devstats.cncf.io/d/5/companies-table?orgId=1). The
overall number of contributors to the project is now almost
[1,900](https://crossplane.devstats.cncf.io/d/18/overall-project-statistics-table?orgId=1&var-period_name=Last%20decade&var-repogroup_name=All).
...
file. There are now more than 40 companies who have publicly endorsed the
...
Science Cloud, Elastic, SAP, IBM, VMWare Tanzu, and Nokia. There are additional
adopters that are also willing to share their usage with the TOC privately.
...
projects there are [120 companies with
...
Across the entire Crossplane project, there are [120 different
...
[ADOPTERS.md](https://github.com/crossplane/crossplane/blob/master/ADOPTERS.md)
file in the main Crossplane repository. Currently, there are over 40 public
...
Nike, Autodesk, Grafana, NASA Science Cloud, Elastic, SAP, IBM, VMWare Tanzu,
and Nokia.
