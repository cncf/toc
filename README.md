...
For more information about TOC elections, see the [election schedule](process/elections-and-voting/election-schedule.md).
...
- [Meeting agenda and presentations](presentations/meeting_presentations.md).
- [Archive of community presentations](presentations/scheduled_presentations.md)
...
For more information about TOC voting, see the [voting policy](process/elections-and-voting/voting.md).


## Special interest groups and working groups

The TOC accomplishes specific work through special interest groups (SIGs) and working groups (WGs).
...
The TOC performs some kinds of work in special interest groups ([SIGs](sigs/cncf-sigs.md)):
...
The TOC has working groups to investigate and discuss the following topics:
...
This section lists [current CNCF projects](https://www.cncf.io/projects/) and a description of project maturity levels (Sandbox, Incubating, Graduated).
